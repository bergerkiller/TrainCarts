...
public class Destinations {
	...
	public static BlockFace getDir(String destname, Location currloc){
		...
		Destinations Me = get(thistag);
    Me.explore(BlockFace.NORTH);
    Me.explore(BlockFace.EAST);
    Me.explore(BlockFace.SOUTH);
    Me.explore(BlockFace.WEST);
		Node r = Me.getDir(destname);
		return r.dir;
	}
